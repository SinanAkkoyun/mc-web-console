    ...
    this.each(function () {
      ...
      _public.register = function (method_type, obj) {
        ...
        if (obj) {
          ...
          var method_exe = (obj.hasOwnProperty('method')) ? obj.method : false
          var method_options = (obj.hasOwnProperty('options')) ? obj.options : []
          var method_help = (obj.hasOwnProperty('help')) ? obj.help : ''
      ...
      _public.tokenize = function (command, options_arr) {
        ...
        if (typeof cmd[0] === 'undefined' || cmd[0] === '') {
          ...
          var option = false; var value = false; var quote_type = false; var quote_open = false
          var first_char = false; var last_char = false; var before_last = false
